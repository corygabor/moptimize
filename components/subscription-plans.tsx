...
const plans = [
  {
    ...
    features: [
      "MAP/CRM audit and platform cleanup",
      "Platform migrations (Marketo, HubSpot, Inflection, SFMC)",
      "Lead lifecycle, scoring, and routing setup",
      "Nurture and campaign workflow builds",
  ...
  },
  {
    ...
    features: [
      ...
      "Custom internal tools and team enablement",
    ],
    recommended: false,
  },
]
